        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="hrms-navbar-collapse-1">
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">当前用户:<shiro:principal/>账号管理 <span class="caret"></span></a>
